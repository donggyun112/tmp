static dmnsn_bvh_node *dmnsn_new_stupid_bvh(const dmnsn_array *objects)
{
...
static void dmnsn_split_add_object(dmnsn_array *objects, const dmnsn_object *object)
{
...
static dmnsn_array *dmnsn_split_objects(const dmnsn_array *objects)
{
...
static dmnsn_array *dmnsn_split_unbounded(dmnsn_array *objects)
{
...
static void dmnsn_flatten_bvh_recursive(dmnsn_bvh_node *node, dmnsn_array *flat)
{
...
static dmnsn_array *dmnsn_flatten_bvh(dmnsn_bvh_node *root)
{
...
static inline booldmnsn_ray_box_intersection(dmnsn_optimized_ray optray, dmnsn_aabb box, double t)
{
